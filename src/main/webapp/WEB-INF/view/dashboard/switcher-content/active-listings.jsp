<li>
    ...
    <div
        ...
        <a class="uk-icon-button uk-position-top-right" onclick="activeListingsDashBoardLoad()"><span
                uk-icon="refresh"></span></a>
        <ul id="activeListings" class="uk-nav uk-nav-default uk-child-width-1-4@m uk-grid-small uk-grid-match list"
            uk-grid>
